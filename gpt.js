class Dice {
    ...
    roll() {
        ...
        if (this.count == 1) {
            document.getElementById("die").style.backgroundImage = 'url("one.jpg")';
        }
        if (this.count == 2) {
            document.getElementById("die").style.backgroundImage = 'url("two.jpg")';
        }
        if (this.count == 3) {
            document.getElementById("die").style.backgroundImage = 'url("three.jpg")';
        }
        if (this.count == 4) {
            document.getElementById("die").style.backgroundImage = 'url("four.jpg")';
        }
        if (this.count == 5) {
            document.getElementById("die").style.backgroundImage = 'url("five.jpg")';
        }
        if (this.count == 6) {
            document.getElementById("die").style.backgroundImage = 'url("six.jpg")';
        }
        if (this.type == 1) {
            if (this.r.checker()) {
